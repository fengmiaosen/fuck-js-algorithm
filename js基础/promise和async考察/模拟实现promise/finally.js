...
// p.then((data) => {
//         console.log(`%c resolve 1: ${data}`, 'color: green')
//     })
//     .catch((err) => {
//         console.log(`%c catch 1: ${err}`, 'color: red')
//     })
//     .finally(() => {
//         console.info('finally 1: completed')
//     });
...
p.finally(() => {
        console.info('finally 2: completed')
    })
    .then((data) => {
        console.log(`%c resolve 2: ${data}`, 'color: green')
    })
    .catch((err) => {
        console.log(`%c catch 2: ${err}`, 'color: red')
    });